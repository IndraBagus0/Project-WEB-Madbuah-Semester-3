    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="product-fruits.html">
              <i class="bi bi-circle"></i><span>Fruits</span>
            </a>
          </li>
          <li>
            <a href="product-pacsel.html">
      ...
      <div class="row">
        ...
        <div class="col-lg-3">
          <div class="card">
            ...
            <div class="mb-3">
              <label for="foto" class="form-label">Contact</label>
              <input type="text" class="form-control" id="foto" name="foto" placeholder="Phone Number" required>
            </div>
