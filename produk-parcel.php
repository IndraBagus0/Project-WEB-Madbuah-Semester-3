...
<body>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="components-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="produk-parcel.php" class="active">
              <i class="bi bi-circle"></i><span>Parsel</span>
            </a>
          </li>
        </ul>
      ...
      <li class="nav-item">
        ...
        <ul id="forms-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="data-costumers.html">
              <i class="bi bi-circle"></i><span>Data Copstumers</span>
            </a>
          </li>
          <li>
            <a href="data-admin.html">
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Parsel</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-2">
          <div class="produk_box">
            <img src="assets/img/parsel1.png" alt="Parsel" style="width:60%">
            <h1>Parsel</h1>
            <p class="harga">$19.99</p>
